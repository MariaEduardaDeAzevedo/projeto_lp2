...
public class ControllerAtividades extends Validacao implements Serializable {
    ...
    public String pegaMaiorRiscoAtividades(String idAtividade) {
        ...
        return atividades.get(idAtividade).pegaMaiorRiscoAtividades(atividades.get(idAtividade), atividades.get(idAtividade));
    }

    /**
     * Metodo responsavel por salvar a collection que contem as atividades e o numero do
     * proximo ID para cadastro de uma atividade.
     */
    ...
    /**
     * Metodo responsavel por recuperar a collection que contem as atividades e o numero
     * do proximo ID para cadastro de uma atividade, de uma utilizacao anterior.
     */
