...
=======
    ...
    /**
     * Metodo responsavel por salvar as collections que contem as pesquisas, os problemas
     * associados e os objetivos associados.
     */
    public void salvarArquivos() {
        Arquivo arquivo = new Arquivo();
        arquivo.salvarArquivos(this.pesquisas, "Pesquisas");
    ...
    /**
     * Metodo responsavel por recuperar as collections que contem as pesquisas, os problemas
     * associados e os objetivos associados de uma utilizacao anterior.
     */
    public void carregarArquivos() {
        Arquivo arquivo = new Arquivo();
        this.pesquisas = (TreeMap<String, Pesquisa>) arquivo.carregarArquivos("Pesquisas");
...
>>>>>>> 279b2b94e2f46ebf34589e2d36d6f4b9ecbd6082
}