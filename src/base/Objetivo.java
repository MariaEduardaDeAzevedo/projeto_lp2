 ...
 * a aderência e a viabilidade do objetivo.
 */
public class Objetivo extends Validacao implements Serializable {
     ...
     * Todo id tem o formato "On", em que n e um numero inteiro.
     */
    private String id;

    /**
     * Constroi um objetivo a partir de um tipo (geral ou especifico), de uma descricao e de dois inteiros correspondentes a
    ...
    /**
     * Retorna a representacao textual de um Objetivo no formato "TIPO - DESCRICAO - VALOR"
     ...
     *
     * @return String que corresponde a representacao textual de um Objetivo
     */
    @Override
     ...
     * O criterio utilizado para a geracao deste inteiro e o id do objetivo.
     *
