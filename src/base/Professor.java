...
public class Professor extends Pesquisador implements Serializable {
    ...
    /**
     * Data de contratacao do professor, que deve, obrigatoriamente, seguir o formato "DD/MM/AAAA", em que DD corresponde ao dia (e deve ser um valor entre 1 e 31), MM corresponde ao mes (devendo
     * ser um valor entre 1 e 12) e AAAA corresponde ao ano, que nao pode ser superior a 2019.
     * O dia e o mes devem, obrigatoriamente, ter dois digitos. Ja o ano deve ter sempre quatro digitos.
     */
    private String dataContratacao;

    /**
     * Constroi um professor a partir de seu nome, sua funcao, sua biografia, seu email, a url de sua foto, seu grau de formacao, sua unidade alocada
     * e sua data de contratacao.
     *
     * @param nome            nome do professor.
     * @param funcao          funcao do professor, que deve, obrigatoriamente, ser "professor".
     * @param biografia       biografia do professor, que e uma descricao textual de sua atuacao em pesquisa.
    ...
    /**
     * Retorna uma String que representa o professor. A representacao segue o formato "NOME (FUNCAO) - BIOGRAFIA - EMAIL - FOTO - FORMACAO - UNIDADE - DATACONTRATACAO".
     *
    ...
    /**
     * Metodo sobrescrito de Pesquisador que permite a alteraçao dos atributos de Professor.
     *
